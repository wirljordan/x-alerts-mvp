...
// 1. Business extraction (onboarding) - Using cheaper model for cost efficiency
...
// 2. Relevance check (every cron cycle) - Using cheaper model for cost efficiency
...
Rules:
- Tweet should be relevant to business topics like marketing, growth, advertising, social media, lead generation, business tools, etc.
- Look for ANY of these signals:
  * Buyer-intent phrases: any tools, recommend, how do I, best way, quick way, tips for, stuck with, need help with, looking for, want to, trying to, need advice, suggestions for
  * Questions about business topics
  * People discussing marketing, growth, or business challenges
  * Requests for recommendations or help
  * General business/marketing discussions that could benefit from your expertise
- Skip ONLY if it's clearly: giveaway, hiring, politics, election, NSFW, or spam.
- Skip if older than 5 minutes.
- Be generous: if the tweet is even remotely related to business/marketing topics, mark as relevant.
- The goal is to engage with potential customers, not just people explicitly asking for help.
...
// 3. Reply generator (main) - Using premium model for high-quality, human-like replies
...
// 4. Shorten / neutralize (fallback if reply too long or unsafe) - Using premium model for quality
