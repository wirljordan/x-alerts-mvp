...
Rules:
- Tweet must contain a buyer-intent phrase such as: any tools, recommend, how do I, best way, quick way, tips for, stuck with, need help with, looking for, want to, trying to, need advice, suggestions for.
- OR tweet must be asking for help/advice/recommendations (even without explicit buyer-intent words).
...
- Keep it strict but not overly restrictive: pass tweets that a business could reply helpfully to.
